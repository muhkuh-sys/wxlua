...
// ---------------------------------------------------------------------------
    ...
    static ptrdiff_t wxluabaseclass_vtable_offsets_wxSimpleHtmlListBox[] = { (((ptrdiff_t)(wxHtmlWindowInterface*)(wxSimpleHtmlListBox*)&wxluatype_TNONE) - ((ptrdiff_t)(wxSimpleHtmlListBox*)&wxluatype_TNONE)) };
