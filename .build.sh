...
LDFLAGS="-static -static-libgcc -static-libstdc++" cmake -DwxWidgets_CONFIG_EXECUTABLE=/tmp/wxwidgets-3.0.2_win32/bin/wx-config -DwxWidgets_COMPONENTS="xrc;xml;net;propgrid;richtext;aui;stc;html;adv;core;base" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=FALSE -DCMAKE_C_FLAGS=-m32 -DCMAKE_CXX_FLAGS=-m32 -DCMAKE_SYSTEM_NAME=Windows -DCMAKE_C_COMPILER=/usr/bin/i686-w64-mingw32-gcc -DCMAKE_CXX_COMPILER=/usr/bin/i686-w64-mingw32-g++ -DCMAKE_RC_COMPILER=/usr/bin/i686-w64-mingw32-windres -DwxLua_LUA_LIBRARY_USE_BUILTIN=FALSE -DwxLua_LUA_LIBRARY_VERSION="5.1" -DwxLua_LUA_INCLUDE_DIR=/tmp/lua-5.1.4/windows_x86/dev/include -DwxLua_LUA_LIBRARY=/tmp/lua-5.1.4/windows_x86/dev/lib/liblua.dll.a ..
STATUS=$?
if [ $STATUS -ne 0 ]; then
	exit 1
fi
...
LDFLAGS="-static -static-libgcc -static-libstdc++" cmake -DwxWidgets_CONFIG_EXECUTABLE=/tmp/wxwidgets-3.0.2_win64/bin/wx-config -DwxWidgets_COMPONENTS="xrc;xml;net;propgrid;richtext;aui;stc;html;adv;core;base" -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED_LIBS=FALSE -DCMAKE_C_FLAGS=-m64 -DCMAKE_CXX_FLAGS=-m64 -DCMAKE_SYSTEM_NAME=Windows -DCMAKE_C_COMPILER=/usr/bin/x86_64-w64-mingw32-gcc -DCMAKE_CXX_COMPILER=/usr/bin/x86_64-w64-mingw32-g++ -DCMAKE_RC_COMPILER=/usr/bin/x86_64-w64-mingw32-windres -DwxLua_LUA_LIBRARY_USE_BUILTIN=FALSE -DwxLua_LUA_LIBRARY_VERSION="5.1" -DwxLua_LUA_INCLUDE_DIR=/tmp/lua-5.1.4/windows_amd64/dev/include -DwxLua_LUA_LIBRARY=/tmp/lua-5.1.4/windows_amd64/dev/lib/liblua.dll.a ..
STATUS=$?
if [ $STATUS -ne 0 ]; then
	exit 1
fi
