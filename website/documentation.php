...
<?php
  ...
  $anchors_href=array("reference", "install", "bindings", "svn", "authors");
  $anchors_text=array("Reference manuals", "Compiling", "Bindings", "SVN", "Authors");
...
<ul>
    ...
    <ul>
        <li>It may not be very pretty, but it shows you exactly what in wxWidgets is wrapped by wxLua.</li>
    </ul>
...
<ul>
    <li>The <a href="http://www.lua.org/manual/">Lua reference manual</a> 
    ...
    <ul>
        <li>Note that this is the first edition for Lua 5.0 and there are important differences to Lua 5.1 and 5.2
            as described on that page. However, it is still a great reference.</li>
    </ul>
...
<ul>
    ...
    <li>Look at a few of the binding files in
        <a href="https://sourceforge.net/p/wxlua/svn/HEAD/tree/trunk/wxLua/bindings/wxwidgets/">wxLua SVN</a> 
        to see how they're constructed and how they're merely simplified versions of the original C/C++ code.</li>
</ul>

<h1 id="svn">Subversion (SVN) repository</h1>
<ul>
    <li>You can browse the SVN repository of wxLua <a href="https://sourceforge.net/p/wxlua/svn/HEAD/tree/trunk/wxLua">here</a>.</li>
</ul>
...
<p>Credits also goes to the tools wxLua is built upon: 
<a href="http://www.wxwidgets.org">wxWidgets toolkit</a>, <a href="http://www.lua.org">Lua</a>,
and <a href="http://www.sourceforge.net">SourceForge.net</a> for hosting the project.</p>
